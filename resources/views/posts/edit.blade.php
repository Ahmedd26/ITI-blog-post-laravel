    ...
    <div class="grid gap-6 mb-6 max-w-xl mx-auto">
        ...
        <div class="">
            ...
            <input type="text" id="title" name="title"
                ...
                placeholder="Your post title goes here" value="{{old('title', $post->title)}}" />
        </div>
        <!--** Description **-->
        <div class="">
            <label for="message"
            ...
            <textarea id="message" rows="4"
                ...
                placeholder="Write your thoughts here..." name="description">{{ $post->description }}</textarea>
        </div>
        <!--** Current Image Display **-->
        <div class="">
            <img class="rounded-lg max-h-80 w-full object-cover border border-zinc-300"
        ...
        <div class="">
            ...
            <p class="mt-2 text-sm text-zinc-500 dark:text-zinc-300" id="image_upload_help">SVG, PNG, JPG or GIF
                (MAX.
                800x400px).</p>
        </div>
        <!--** Creator **-->
